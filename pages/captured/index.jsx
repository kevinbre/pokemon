...
function PokemonInfo() { 
  ...
  return (
    <>
    <Container >
    <Card.Text className="d-flex justify-content-center mt-5" style={{fontWeight: 800, fontSize: 26, color: "#8a78e8"}}> Mis pokemon </Card.Text>
      <Row>
      ...
      <Col key={i} md={3} className="d-flex justify-content-center mt-4">
        ...
        <Card.Body className="d-flex flex-column align-items-center bg-dark rounded">
          <Card.Title className="text-light pb-3 text-capitalize">{pokemon.name}</Card.Title>
