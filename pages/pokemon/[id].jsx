...
import pokemonType from "../../src/mockup/pokeMockUp";
...
function Pokemon() {
  ...
  return (
    <>
      <Head>
        <title className="text-capitalize">{myPokemon.name}</title>
                ...
                >
                  ...
                  {myPokemon.stats?.map((base, i) => (
                    <Row key={i}>
                      {" "}
                      <ProgressBar
                        className="p-0 mt-4 text-center d-flex text-center w-100"
                        animated
                        variant="danger"
                        now={base.base_stat}
                        label={base.base_stat + " " + base.stat.name + ""}
                        key={1}
                      />
                    </Row>
                  ))}
